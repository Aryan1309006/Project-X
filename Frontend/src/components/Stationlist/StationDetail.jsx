    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <div className="w-16 h-16 rounded-2xl bg-white border border-gray-200
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Back button */}
        <button onClick={() => navigate(-1)}
          className="group inline-flex items-center gap-2 mb-7
            ...
            <div className="group bg-white rounded-2xl border border-gray-200
              ...
              {coverImage ? (
                <div className="relative w-full h-44 overflow-hidden">
                  <img src={coverImage} alt={station.name}
              ...
              <div className="p-5">
                ...
                {maxPower > 0 && (
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1
                                  rounded-full bg-amber-50 border border-amber-100
                                  text-amber-600 text-xs font-bold mb-3
                ...
                {/* Divider */}
                <div className="h-px bg-gradient-to-r from-emerald-100/60
                                via-gray-100 to-teal-100/60 mb-5" />
                  ...
                  {[
                    ...
                    <div key={stat.label}
                      className={`flex flex-col items-center justify-center
                                  p-3 rounded-xl border ${stat.bg}
                                  hover:scale-105 hover:shadow-sm
                                  transition-all duration-200 cursor-default`}>
                      <FontAwesomeIcon icon={stat.icon}
                        className={`${stat.iconColor} mb-1.5 text-sm`} />
                      <span className="text-gray-800 font-bold text-base leading-none">
                        {stat.value}
                      </span>
                ...
                {station.pricePerUnit && (
                  <div className="flex items-center justify-between
                                  ...
                                  hover:bg-emerald-100/60 hover:border-emerald-200
                ...
                {station.openingHours && (
                  <div className="flex items-center justify-between
                                  ...
                                  bg-gray-50 border border-gray-100
                                  hover:bg-gray-100/60 hover:border-gray-200
                                  transition-all duration-200">
                    <span className="flex items-center gap-2 text-gray-500 text-sm">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {station.facilities.map((facility, i) => {
                        const icon =
                          facilityIconMap[facility.toLowerCase()] || faCircleCheck;
                        return (
                          <div key={i}
                            className="flex items-center gap-1.5
                                       ...
                                       hover:text-emerald-600 hover:scale-105
                                       transition-all duration-200 cursor-default">
                  ...
                  <div className="space-y-2.5">
                    {chargers.length > 0 ? (
                      chargers.map((charger, index) => {
                        const colors = chargerTypeColors[charger.type] || {
                          bg: "bg-gray-50", border: "border-gray-200", text: "text-gray-600",
                        };
                        return (
                          <div key={index}
                            className="group/port flex items-center justify-between
                                       p-4 rounded-xl border border-gray-100
                                       bg-gray-50/60 hover:bg-white
                                       hover:border-emerald-200
                                       hover:shadow-md hover:shadow-emerald-50
                            ...
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 rounded-xl
                                              ...
                                              group-hover/port:border-emerald-200
                                              group-hover/port:bg-emerald-50
                                              group-hover/port:scale-110
                                              flex items-center justify-center
                                              text-gray-400 group-hover/port:text-emerald-600
                                              text-xs font-bold
                                              transition-all duration-200">
                            ...
                            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg
                                            ...
                                            group-hover/port:bg-emerald-100
                                            transition-all duration-200">
                      ...
                      <div className="flex flex-col items-center justify-center py-10 text-center">
                        <div className="w-12 h-12 rounded-xl bg-gray-50 border border-gray-100
                        ...
                        <div key={index}
                          ...
                          {review.comment && (
                            <p className="text-gray-500 text-sm leading-relaxed
                                          border-t border-gray-100 pt-2.5 mt-0.5">
                              {review.comment}
                            </p>
                          )}
                        </div>
